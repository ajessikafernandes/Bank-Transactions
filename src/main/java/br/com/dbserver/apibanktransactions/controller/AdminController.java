...
//import br.com.dbserver.apibanktransactions.model.AccountStatement;
...
//        List<AccountStatement> clients = adminService.clientList();
//        if (clients.size() > 0) {
//            return ResponseEntity.ok(clients);
//        } else {
//            return ResponseEntity.badRequest()
//                    .body(new NoRegisteredCustomers("Não há clientes cadastrados no sistema."));
//        }
//    }
//}
